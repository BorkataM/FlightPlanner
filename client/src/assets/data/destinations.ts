...
export const DESTINATIONS: Destination[] = [
  ...
  { name: 'Paris',    country: 'France',    price: '658',  image: IMAGES.destinations.paris,    gradient: 'from-amber-800 via-yellow-700 to-orange-900',  smartScore: 91, tag: 'bestValue', liked: false },
  { name: 'Maldives', country: 'Maldives',  price: '1246', image: IMAGES.destinations.maldives, gradient: 'from-cyan-800 via-teal-600 to-blue-800',       smartScore: 96, tag: 'eco',       liked: false },
]
